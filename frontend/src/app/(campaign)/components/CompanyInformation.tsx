...
const CompanyInformation: React.FC<CampaignDetailProps> = ({ campaignData }) => {
    return (
        <div className="flex flex-col lg:flex-row gap-8 p-4">
            <div className="flex-1 p-6 border border-gray-300 rounded-lg bg-gray-100">
                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <p><strong>Website:</strong> <a href={`https://${campaignData.businessOverview.website}`}
                                                    target="_blank" rel="noopener noreferrer"
                                                    className="text-blue-500 hover:underline">{campaignData.businessOverview.website}</a>
                    </p>
                    ...
                    <p><strong>Company Vision:</strong> {campaignData.businessOverview.vision}</p>
                </div>
            </div>
        </div>
    );
