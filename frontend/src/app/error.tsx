    ...
    return (
        <div className="relative min-h-screen w-full bg-white text-black overflow-hidden">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center">
                ...
                {/* This pushes the content down */}

                <div className="relative text-center mb-8"> {/* Added margin-bottom for spacing */}
                    <div
                        className="relative mx-auto h-0.5 w-32 overflow-hidden mb-8"> {/* Moved this above the buttons */}
                        <div
                            className="absolute inset-0 bg-gradient-to-r from-transparent via-white to-transparent animate-slide"/>
                    </div>
