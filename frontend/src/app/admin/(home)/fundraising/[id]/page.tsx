    ...
    <div className="flex flex-col items-center min-h-screen bg-gray-100 p-4">
      <div className="bg-white shadow-xl rounded-lg p-8 max-w-2xl w-full text-center">
        ...
        <div className="space-y-2 mb-8">
          ...
          <p><strong>LinkedIn:</strong> <a href={campaign.linkedInProfile} target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">{campaign.linkedInProfile}</a></p>
