  ...
  return (
    <section className="mb-6 bg-gray-50 p-4 rounded-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <input name="name" value={formData.name || ''} onChange={handleChange} placeholder="Campaign Name" className="p-2 border rounded" />
        ...
        <input name="founderName" value={formData.founderName || ''} onChange={handleChange} placeholder="Founder Name" className="p-2 border rounded" />
        ...
        <input name="linkedInProfile" value={formData.linkedInProfile || ''} onChange={handleChange} placeholder="LinkedIn Profile" className="p-2 border rounded" />
      </div>
    </section>
  );
};
