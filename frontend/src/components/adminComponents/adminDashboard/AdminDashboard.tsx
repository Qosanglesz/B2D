...
//     const [investmentTopData, setInvestmentTopData] = useState([]);
...
//         try {
//             const response = await fetch('api/top5Campaigns');
//             if (!response.ok) {
//                 throw new Error('Failed to fetch top data investment data')
//             }
//             const data = await response.json();
//             setInvestmentTopData(data)
//         } catch (err) {
//             setError('Error fetching top data investment data. Please try again later.')
//         } finally {
//             setIsLoading(false);
//         }
//     };
...
//                 </section>
//                 <section>
//                     <h2 className="text-xl font-semibold mb-4">Top 5 Investment</h2>
//                     <div className="bg-white p-4 rounded-lg shadow" style={{height: '400px'}}>
//                         <InvestmentPieChart data={investmentTopData}/>
//                     </div>
//                 </section>
